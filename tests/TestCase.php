...
use JeffersonGoncalves\SsoClient\SsoClientServiceProvider as LaravelSsoClientServiceProvider;
...
abstract class TestCase extends Orchestra
{
    protected function getPackageProviders($app): array
    {
        return [
            ...
            LaravelSsoClientServiceProvider::class,
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        config()->set('sso-client.server_url', 'https://sso.test');
        config()->set('sso-client.client_id', 'client');
        config()->set('sso-client.client_secret', 'secret');
    }

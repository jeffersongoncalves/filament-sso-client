...
![Filament SSO Client](https://raw.githubusercontent.com/jeffersongoncalves/filament-sso-client/2.x/art/jeffersongoncalves-filament-sso-client.png)
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-sso-client/tests.yml?branch=2.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-sso-client/actions?query=workflow%3ATests+branch%3A2.x)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-sso-client/pint.yml?branch=2.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-sso-client/actions?query=workflow%3Apint+branch%3A2.x)
